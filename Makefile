...
CLIENT := blocks.exe
SERVER := server.exe
CFLAGS := -O2 -I$(SRC_DIR) -I$(SRC_DIR)/client -I$(LIB_DIR) -DWIN32_LEAN_AND_MEAN -D_WIN32_WINNT=0x0601
LDFLAGS := -lglfw3 -lopengl32 -lgdi32 -lws2_32 -lwinmm -lmswsock -lcglm -lm
CC := gcc
else
CLIENT := blocks
SERVER := server
